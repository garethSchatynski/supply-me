...
session_start();
include 'db.php';
$pagename="Supplyme Registration";
echo "<head>";
...
echo "<div class=container>";
echo "<div class=row>";
echo "<form method=post class='col s12' action=getregister.php>" ;
//first name
echo "<div class=row>";
...
echo "<td><input id=company type=text name=r_company size=35></td></tr>";
echo "<label for=company>Company Name (If have one)</label>";
echo "</div>";
echo "</div>";
//address
echo "<div class=row>";
